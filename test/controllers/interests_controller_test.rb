...
class InterestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interest" do
    assert_difference('Interest.count') do
      post interests_url, params: { interest: { name: @interest.name, order: @interest.order, resume_id: @interest.resume_id } }
    end
  ...
  test "should update interest" do
    patch interest_url(@interest), params: { interest: { name: @interest.name, order: @interest.order, resume_id: @interest.resume_id } }
